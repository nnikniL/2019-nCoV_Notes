...
先放一张图：
 ...
 ![](./images/sars_progress_china.png)

图中的曲线根据国家卫健委网站的全国疫情播报数据[6-7]绘制而成。

再放一张微观点的图：

 ![](./images/sars_progress_china_micro.png)
...
### 新冠肺炎武汉疫情阶段分析（Phase of 2019-nCoV in China）

#### 病例数据

同样地，绘制了一张图：

![](./images/2019ncov_progress_china.png)
...
![](./images/2019ncov_progress_china_200131.png)

上图可以看到，确诊数和在疗数的增长率都在快速下降；但是在疗数仍存在明显的增长，情况还不够乐观。
...
但目前从数据来看，尤其是下表中$\frac{dN(t)}{t}$，说明累计确诊数还在以非线性的方式增长：
![](./images/2019ncov_progress_ConfirmedCaseDiff.PNG)
对$\frac{dN(t)}{t}$在2020.1.23~2020.2.4的数据上进行线性拟合后得到：$\frac{dN(t)}{t}=(t-t_{0})\times 256.0055-253.7308$，$t_{0}=2020.1.22$
即：
![](./images/trend/2019ncov_trend_y_of_CaseDiff_until20200204.PNG)
可见该变量求值像极了一个线性问题，其中$std(真实数据-拟合数据)=185.9531$

如果按照这样的趋势发展，截止到2月8日24时，突破3.15W人的可能性较大,即将新增(17+16+15+14)*256.0055-253.7308*4=14856左右的确诊cases。
<br/>
...
#### 2020年2月18日，曙光
在<a href="https://github.com/nnikniL/2019-nCoV_Notes/commit/8c6b331702e77c3b5e9eef04d68f05baac66062b">上次提交的更新</a>中提到的<a href="./SARS疫情与武汉新冠疫情.md#病例数据">拐点</a>显然已如期而至。如下图：
![](./images/2019ncov_progress_china_200218.png)
上图中可见，1、累计确诊数增速下降至2.68%；2、确诊与治疗的平衡点达到（在疗增速0.14%），即本文定义的<a href="./SARS疫情与武汉新冠疫情.md#病例数据">拐点</a>已经到达。

那么控制传染病的关键之二，传染源和传播途径情况如何呢？
<br/>

##### 传染源发展规律
先看图：
![](./images/200218_ana/virsrc_200218.png)
上文也提到，目前确诊/医疗平衡点达到，如图中两者的增量值dN只差1888-1708=180人；分地区看，湖北在疗增速已降至0.99%，而非湖北在疗已经是负增长了。数据上说明，传染源头已构不成威胁，全国性爆发风险持续降低；在03年非典发展情况中，此节点一个多月后世卫组织会将中国从疫区中除名[3]。至于是不是疫区国，不用太纠结一个名分，实质性影响有多大才是重要的。
<br/>

##### 传播途径发展规律
先看图：
![](./images/200218_ana/vir_onthefly_200218.png)
其中有一列数据很有意思，密接确诊比，特别是从2.12至2.13,发生突变，具体突变原因不详；这个数据可以说明每个确诊病例平均接触7.74人，即差不多两个家庭（中国每户人数平均3.13），或者是否可以理解为4位老人+2位年轻夫妇+1位孩子的模式？
<br/>
在实际新增观察中，可能是采样频率低引入了噪声，所以增长率看起来没那么规律。
<br/>

##### 小结
综合以上来看，如果政策激进点，其实可以逐步放开复工和封锁了，但同时会增大口罩等防护物资需求。同时，复工后仍不能放松对疫情的监控。非典时期过后的小SARS也曾出现过，对比两者的潜伏性，小新冠出现的可能性更大。
<br/>
另一方面，如果想要尽快消灭疫情，还需要不断加大医疗资源的投入，未来必然会出现源源不断的医生和物资往湖北输送，并且持续一段时间。
<br/>

#### 2020年3月7日,胜利已悄然到来
与上文分析的基本一致，疫情按照预计的路线发展着，今天是女生节，特殊的日子下，日常更新一下。

首先还是基于现有数据做些推测，湖北在疗的数据中，5日均增长率为-7.00%，10日均增长率为-6.51%，按照这样的速度，湖北在3.22左右会基本完成去库存；非湖北的5日均增长率为-14.95%，10日均增长率为-13.36%，对应的日期节点为3月14日（是个好日子）。

为什么说去库存是基本完成呢?因为总有些疑难人员不在平均水平附近，但这样的人毕竟从统计学来说不会太多，所以可以认为库存基本完成去化。


然后基于数据分析下可能还存在的风险点，密接确诊比一直在增长，总体达到8.33,；<b>增量</b>cases对应的是（比如今天实际新增观察1604，新增确诊99）16.20，也就是每确诊1例的同时有16人需要被医学观察；而在2月18日时，数值为14885/1888=7.88；自2月18日以来，仅2.19、2.29和3.1两日的增量cases密接确诊确诊比低于7.88，而其它都高于11，最高的37.71发生在2月20日。为什么会出现这些不好的信号呢，原因不详。

虽然国内已经已实现完全可控，但是境外的情况并不容乐观。
